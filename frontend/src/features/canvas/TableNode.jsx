...
export const TableNode = memo(({ id, data }) => {
  ...
  return (
    <div className="w-84 rounded-2xl border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl shadow-slate-200/40 dark:shadow-black/60 overflow-hidden font-sans transition-all duration-150 hover:border-sky-300 dark:hover:border-sky-500 nowheel">
      {/* Node Header */}
